# In this file we will be defining some of the variable which we will use while implementing the 2048 game
# This file contains the constant variables like size, background-color, color, font etc.
SIZE = 400
GRID_LEN = 4
GRID_PADDING = 10
